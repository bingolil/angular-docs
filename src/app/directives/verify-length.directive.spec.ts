...
import { VerifyLengthDirective, verifyLengthValidator } from './verify-length.directive';
  ...
  <form #myForm="ngForm">
    ...
    ></docs-checkbox-group>
     <docs-checkbox-group
      ...
      [(ngModel)]="ages" [options]="ageList"
    ></docs-checkbox-group>
  </form>
  <!-- ==================================== -->
  <div [formGroup]="userForm">
    <docs-checkbox-group name="hobby" formControlName="hobby" [options]="hobbyList"></docs-checkbox-group>
    <docs-checkbox-group formControlName="ages" [options]="ageList" ></docs-checkbox-group>
  </div>
  `
})
